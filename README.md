...
> **Jméno a příjmení:** `Vítek Dolanský`

> **Název projektu:** `Bremtly — your content partner`
...
`https://createcontent.club/1-b | https://www.instagram.com/createcontent.club?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw== - jedni z prvních tvůrců na které jsem narazil když jsem se službou začcal - inspirovali mě.

https://www.pblaunch.com/?utm_source=ig&utm_medium=social&utm_content=link_in_bio | https://www.instagram.com/personalbrandlaunch?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw== - tvůrkyně od které jsem se taky naučil hodně věcí o sociálních sitích a podnikání celkově.

https://socials.cz/#top
...
| Výstup | Odkaz |
|---|---|
| GitHub Pages (live) | [`(https://pslib-cz.github.io/2025-p2a-web-volny-projekt-Vitek-Dolansky/)`](zde) |
